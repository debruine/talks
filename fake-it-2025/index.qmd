```{r, include=FALSE}
url <- "debruine.github.io/talks/fake-it-2025/"
subtitle <- sprintf("[%s](https://%s)", url, url)
# make QR code
qrcode::qr_code(url) |> qrcode::generate_svg("images/qrcode.svg")
```
---
title: "Fake It Until You Make It"
subtitle: "How and why to simulate research data<br/>"
...
[![`r url`](images/qrcode.svg)](https://`r url`)
