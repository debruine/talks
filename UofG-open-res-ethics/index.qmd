...
subtitle: "[https://debruine.github.io/talks/UofG-open-res-ethics/](https://debruine.github.io/talks/UofG-open-res-ethics/)"
...
* [Glasgow Open Research](https://www.gla.ac.uk/myglasgow/openresearch/)
...
* Address data sharing in template consent forms
* Consistency of data management plans across consent, info, DMP, DPIA
* Registered report-friendly procedures
* Team research-friendly procedures
* Should ethics committees do methodological review? [(Lakens, 2023, Nature)](https://www.nature.com/articles/d41586-022-04504-8)
