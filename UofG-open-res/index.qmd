...
[![Scriberia. CC-BY 4.0. DOI: 10.5281/zenodo.3332807](images/reproducibility.jpg)](https://doi.org/10.5281/zenodo.3332807){fig-alt="Image of a map map showing the 'path' from data to tools to results to code"}
...
Matt Mahon  
[Slides](https://gla.sharepoint.com/:p:/s/RIMFiles/EdozsddvXqJNisI5VPv3PzoBwzZIorGBFsvS2QtRB-NQ8A?e=ug0bch) (via SharePoint)
