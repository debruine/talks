...
[![UK Reproducibility Network](images/ukrn.jpg){fig-alt="Purple globe with UK in green and letters UKRN"}](https://www.ukrn.org/)

[![Framework for Open and Reproducible Research Training](images/forrt.png){fig-alt="Grey hexagon with a castle tower insite and the word FORRT below"}](https://forrt.org/)

[![ReproducibiliTea / @GlasgowTea](images/reproducibilitea.jpg){fig-alt="Blue hexagon with a teacup inside and the word ReproducibiliTea below"}](https://twitter.com/glasgowtea)

:::

## Open Research Across Disciplines

[![](images/disciplines.png)](https://www.ukrn.org/disciplines/)

## Next Steps

:::: columns
[Easing into Open Science](https://doi.org/10.1525/collabra.18684)
