---
title: "Code Review"
subtitle: "[debruine.github.io/talks/RIOT-code-review-2022/](https://debruine.github.io/talks/RIOT-code-review-2022/)"
...
<div style="position: absolute; top: 0%; right: 0%; width: 200px;"><a href="https://debruine.github.io/faux/"><img src="images/faux.png" width="200px"></a></div>
...
sim_data <- faux::sim_design(
  within  = list(version   = c(v1 = "Version 1", v2 = "Version 2"), 
                 condition = c(ctl = "Control", exp = "Treatment")),
  between = list(species   = c("cat", "dog")),
  n = 30,
  mu = data.frame(
    v1_ctl = c(100, 100), v1_exp = c(100, 90), 
    v2_ctl = c(100, 110), v2_exp = c(100, 110),
    row.names = c("cat", "dog")),
  sd = c(cat = 10, dog = 20),
  r = 0.5,
  dv = c(score = "Excitability Score"),
  id = c(id = "Subject ID"),
...
```{r, echo = FALSE}
arrange(sim_data, id) |>
  filter(id %in% c("S01", "S31")) |>
  gt() |>
  gtExtras::gt_theme_dark(table.font.size = px(25)) |>
...
plot(sim_data, "species", "condition",
...
[debruine.github.io/talks/RIOT-code-review-2022/](https://debruine.github.io/talks/RIOT-code-review-2022/) ([code](https://github.com/debruine/talks/))
